...
DWORD WINAPI PipeThread(LPVOID lpParameter)
{
	...
	if (pipe != INVALID_HANDLE_VALUE)
	{
		...
		SplitPlayPipe::PipeMessageHeader msgHeader;
		...
		while (true)
		{
			...
			{
			case SplitPlayPipe::PipeMessageType::SetupHook:
				{
					const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetupHook*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetupMessageFilter:
				{
					const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetupMessageFilter*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetupMessageBlock:
				{
					const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetupMessageBlock*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::WakeUpProcess:
			{
			...
			case SplitPlayPipe::PipeMessageType::UpdateMainWindowHandle:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMesasgeUpdateMainWindowHandle*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::StartFocusMessageLoop:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageStartFocusMessageLoop*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::StopFocusMessageLoop:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageStopFocusMessageLoop*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetupState:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetupState*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetupMessagesToSend:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetupMessagesToSend*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetDrawFakeCursor:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetDrawFakeCursor*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetExternalFreezeFakeInput:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetExternalFreezeFakeInput*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::AddSelectedMouseOrKeyboard:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMesasgeAddSelectedMouseOrKeyboard*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::AddHandleToRename:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageAddHandleToRename*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetControllerIndex:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetControllerIndex*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetUseDinput:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageUseDinput*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetUseOpenXinput:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetUseOpenXinput*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetDinputDeviceGuid:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetDinputDeviceGuid*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetDinputHookGetDeviceState:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetDinputHookGetDeviceState*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetSetWindowPosSettings:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetSetWindowPosSettings*>(messageBuffer);
			...
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetCreateSingleHIDName*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetClipCursorHookOptions:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetClipCursorHookOptions*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetAllowFakeCursorOutOfBounds:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetAllowFakeCursorOutOfBounds*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetToggleCursorVisibilityShortcut:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetToggleCursorVisibilityShortcut*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetRawInputBypass:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageSetRawInputBypass*>(messageBuffer);
			...
			case SplitPlayPipe::PipeMessageType::SetShowCursorWhenImageUpdated:
			{
				const auto body = reinterpret_cast<SplitPlayPipe::PipeMessageShowCursorWhenImageUpdated*>(messageBuffer);

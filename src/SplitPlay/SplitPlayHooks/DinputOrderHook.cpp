	...
	{
		{
			...
			pCtrlr8W->SetCooperativeLevel(SplitPlay::SplitPlayGuiHwnd, DISCL_BACKGROUND | DISCL_NONEXCLUSIVE);
			ctrlrFormat8W = 1;
...

		{
			...
			pCtrlr8A->SetCooperativeLevel(SplitPlay::SplitPlayGuiHwnd, DISCL_BACKGROUND | DISCL_NONEXCLUSIVE);
			ctrlrFormat8A = 1;
...

		{
			...
			pCtrlr7W->SetCooperativeLevel(SplitPlay::SplitPlayGuiHwnd, DISCL_BACKGROUND | DISCL_NONEXCLUSIVE);
...

		{
			...
			pCtrlr7A->SetCooperativeLevel(SplitPlay::SplitPlayGuiHwnd, DISCL_BACKGROUND | DISCL_NONEXCLUSIVE);

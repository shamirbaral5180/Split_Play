...
class MouseButtonFilter : public MessageFilterBase<SplitPlayMessageFilterIDs::MouseButtonFilterID, WM_LBUTTONDOWN, WM_XBUTTONUP>
{
public:
	...
	{
		return
			"Filters the mouse button press/release messages to only pass synthesized messages by SplitPlay Input. "

...
// This file needs to be used in both SplitPlayHooks and SplitPlayLoader for pipe communication

namespace SplitPlayPipe
{
...
{
	SplitPlayHookIDs hookID;
	bool install;
};

struct PipeMessageSetupMessageFilter
{
	SplitPlayMessageFilterIDs filterID;
	bool enable;
};

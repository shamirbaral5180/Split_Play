...
public:
	...
	{
#define SPLITPLAY_MMFKEY(x, y) ((FakeMouseKeyboard::IsKeyStatePressed(x)) ? (y) : (0))

		return	SPLITPLAY_MMFKEY(VK_CONTROL, MK_CONTROL) |
				SPLITPLAY_MMFKEY(VK_SHIFT, MK_SHIFT) |
				SPLITPLAY_MMFKEY(VK_LBUTTON, MK_LBUTTON) |
				SPLITPLAY_MMFKEY(VK_MBUTTON, MK_MBUTTON) |
				SPLITPLAY_MMFKEY(VK_RBUTTON, MK_RBUTTON) |
				SPLITPLAY_MMFKEY(VK_XBUTTON1, MK_XBUTTON1) |
				SPLITPLAY_MMFKEY(VK_XBUTTON2, MK_XBUTTON2);

#undef SPLITPLAY_MMFKEY
